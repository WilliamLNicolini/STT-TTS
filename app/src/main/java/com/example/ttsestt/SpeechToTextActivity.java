...
public class  SpeechToTextActivity extends AppCompatActivity {
    ...
    private void capturar(){
        ...
        iSTT.putExtra(RecognizerIntent.EXTRA_PROMPT, "Fala tu que eu tô cansado!");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100) {
            if (resultCode == RESULT_OK && data != null) {
                ...
                if(textoReconhecido.toUpperCase().contains("FUNDO ROXO")){
                    layoutSTT.setBackgroundColor(0x9400D3);
                }

                if(textoReconhecido.toUpperCase().contains("FUNDO LARANJA")){
                    layoutSTT.setBackgroundColor(0xFF8C00);
                }
